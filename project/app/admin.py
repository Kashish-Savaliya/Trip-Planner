...
from .models import User, Place, Nearby_Place,State, hist_back, travel_and_cost
...
class TripDetailAdmin(admin.ModelAdmin):
    list_display = ('category', 'title', 'cost', 'description')    #This defines which fields are shown in the list view of the model in the Django admin panel.
